...
namespace osuCrypto
{
	void MiniReceiver1::init(u64 myInputSize, u64 theirInputSize, u64 psiSecParam, PRNG & prng, span<Channel> chls)
	{
	...
	void MiniReceiver1::outputBigPoly(span<block> inputs, span<Channel> chls)
	{
