...
namespace osuCrypto
{
	...
	void MiniSender1::init(u64 myInputSize, u64 theirInputSize, u64 psiSecParam, PRNG & prng, span<Channel> chls)
	{
	...
	void MiniSender1::outputBigPoly(span<block> inputs, span<Channel> chls)
	{
