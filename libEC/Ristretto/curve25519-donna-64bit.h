...
#if defined(HAVE_NATIVE_UINT128)
	t[0]  =  ((uint128_tt) r0) * s0;
	t[1]  =  ((uint128_tt) r0) * s1 + ((uint128_tt) r1) * s0;
	t[2]  =  ((uint128_tt) r0) * s2 + ((uint128_tt) r2) * s0 + ((uint128_tt) r1) * s1;
	t[3]  =  ((uint128_tt) r0) * s3 + ((uint128_tt) r3) * s0 + ((uint128_tt) r1) * s2 + ((uint128_tt) r2) * s1;
	t[4]  =  ((uint128_tt) r0) * s4 + ((uint128_tt) r4) * s0 + ((uint128_tt) r3) * s1 + ((uint128_tt) r1) * s3 + ((uint128_tt) r2) * s2;
#else
...
#if defined(HAVE_NATIVE_UINT128)
	t[0] += ((uint128_tt) r4) * s1 + ((uint128_tt) r1) * s4 + ((uint128_tt) r2) * s3 + ((uint128_tt) r3) * s2;
	t[1] += ((uint128_tt) r4) * s2 + ((uint128_tt) r2) * s4 + ((uint128_tt) r3) * s3;
	t[2] += ((uint128_tt) r4) * s3 + ((uint128_tt) r3) * s4;
	t[3] += ((uint128_tt) r4) * s4;
#else
...
#if defined(HAVE_NATIVE_UINT128)
		t[0] = ((uint128_tt) r0) * r0 + ((uint128_tt) d4) * r1 + (((uint128_tt) d2) * (r3     ));
		t[1] = ((uint128_tt) d0) * r1 + ((uint128_tt) d4) * r2 + (((uint128_tt) r3) * (r3 * 19));
		t[2] = ((uint128_tt) d0) * r2 + ((uint128_tt) r1) * r1 + (((uint128_tt) d4) * (r3     ));
		t[3] = ((uint128_tt) d0) * r3 + ((uint128_tt) d1) * r2 + (((uint128_tt) r4) * (d419   ));
		t[4] = ((uint128_tt) d0) * r4 + ((uint128_tt) d1) * r3 + (((uint128_tt) r2) * (r2     ));
#else
