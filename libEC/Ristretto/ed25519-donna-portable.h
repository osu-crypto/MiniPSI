...
/* uint128_tt */
		...
		#define hi128(a) (a.hi)
			...
			#define HAVE_NATIVE_UINT128
			typedef unsigned uint128_tt __attribute__((mode(TI)));
		...
		#define HAVE_UINT128
		#define mul64x64_128(out,a,b) out = (uint128_tt)a * b;
		#define shr128_pair(out,hi,lo,shift) out = (uint64_t)((((uint128_tt)hi << 64) | lo) >> (shift));
		#define shl128_pair(out,hi,lo,shift) out = (uint64_t)(((((uint128_tt)hi << 64) | lo) << (shift)) >> 64);
		...
		#error Need a uint128_tt implementation!
	#endif
#endif
